...
INSTANTIATE_TEST_CASE_P(TestCases, StringListTest,
    testing::ValuesIn(
...
class IntListTest :
    public testing::TestWithParam<std::pair<std::vector<int64_t>, std::string>> {
};
...
INSTANTIATE_TEST_CASE_P(TestCases, IntListTest,
    testing::ValuesIn(
        std::vector<std::pair<std::vector<int64_t>, std::string>>{
            {{1}, "1"},
            {{-1, 0}, "-1,0"},
...
INSTANTIATE_TEST_CASE_P(TestCases, FloatListTest,
    testing::ValuesIn(
