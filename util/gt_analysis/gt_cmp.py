...
def compute_stats(nogt: Logs, gt: Logs, *, pass_num: int, total_compile_time_seconds):
    ...
    result = {
        ...
        'Heuristic Time (No GT)': compile_times.first_heuristic_time(nogt),
        'Heuristic Time (GT)': compile_times.first_heuristic_time(gt),
        ...
        'Heuristic Time (opt. blocks only) (No GT)': compile_times.first_heuristic_time(nogt_opt),
        'Heuristic Time (opt. blocks only) (GT)': compile_times.first_heuristic_time(gt_opt),
