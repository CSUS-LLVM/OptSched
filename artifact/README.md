...
([CSUS-LLVM/llvm-project @ TACO-26](https://github.com/CSUS-LLVM/llvm-project/tree/TACO-26))
whose AMDGPU backend uses **OptSched**
([CSUS-LLVM/OptSched @ TACO-26](https://github.com/CSUS-LLVM/OptSched/tree/TACO-26)),
