#!/usr/bin/env bash
# Clone, patch, and build CSUS-LLVM (TOPLAS-25) with the OptSched GPU ACO
...
LLVM_SHA="${LLVM_SHA:-a9f4c7f0cbfeab934ca6ca1f1782a4414adbba06}"   # branch TOPLAS-25
OPTSCHED_REPO=https://github.com/CSUS-LLVM/OptSched.git
OPTSCHED_SHA="${OPTSCHED_SHA:-60e7ffe34e6cff2574c4288b9b16e2e54835b40d}" # branch TOPLAS-25
